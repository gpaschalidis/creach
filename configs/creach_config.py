...
class LossConfig:
    ...
    z_min: Loss = Loss(type='l1', weight= 0)
    vertices_consist: Loss = Loss(type='l1', weight=0)

    rh_vertices: Loss = Loss(type='l1', weight= 10)
    start_joint: Loss = Loss(type='l1', weight= 0)
    lh_vertices: Loss = Loss(type='l1', weight= 10)
    ...
    lh2smplx_idx: str = f'{cdir}/../consts/lhand_smplx_ids.npy'
    feet2smplx_idx: str = f'{cdir}/../consts/feet_smplx_ids.npy'
#################### NETWORK CONFIG ########################
...
class Config:
    ...
    joint_start_rh: int = 21
    joint_target_rh: int = 19

    joint_start_lh: int = 20
    joint_target_lh: int = 18
